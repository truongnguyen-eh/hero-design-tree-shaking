...
import HorizontalBarChart, { HorizontalBarChartProps } from '..';
import { COLOR_MESSAGE_ERROR } from '../../common/colorScale';
import theme from '../../../../theme';

type Data = HorizontalBarChartProps;
...
describe('Bar Chart', () => {
  ...
  it('renders correctly', () => {
    ...
    expect(container.querySelectorAll('g.grid-line').length).toBe(11);
  ...
  it('can click on a bar segment', () => {
    ...
    const bar = container.querySelector(
      'rect[data-test-id="horizontal-bar-chartMay07th2.2"]'
    );
  ...
  it('matched multiple segment', async () => {
    ...
    ).toHaveAttribute('filter', 'drop-shadow(1px 1px 4px rgb(0 0 0 / 0.3))');
  });
  ...
  it('custom bar color', () => {
    ...
    expect(
      getByTestId('horizontal-bar-chartMay07th2.2').getAttribute('fill')
  ...
  `('return correct bar height', ({ size, height }) => {
    ...
    expect(
      getByTestId('horizontal-bar-chartMay07th2.2').getAttribute('height')
  ...
  `(
    ...
    async ({ disabledDirection, enabledDirection }) => {
      ...
      const disableButton = getByTestId(
        `horizontal-bar-chart-navigate-button-${disabledDirection}`
      );
      ...
      const enabledButton = getByTestId(
        `horizontal-bar-chart-navigate-button-${enabledDirection}`
      );
