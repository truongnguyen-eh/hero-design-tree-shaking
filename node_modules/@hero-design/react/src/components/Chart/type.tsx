...
export type LegendConfig = BaseLegendConfig &
  (BasicLegendConfig | CheckboxLegendConfig);

export type BarConfig<Data> = {
  /**
   * Handler for clicking on a bar section
   */
  onClick?: (e: PointerEvent, value: Series<Data> & { legend: string }) => void;
  /**
   * Show total badge
   */
  showTotal?: boolean;
...
export type MatchedSegment = Array<{
  label: string;
  legend: string;
}>;

export type DataValue = number | undefined;
