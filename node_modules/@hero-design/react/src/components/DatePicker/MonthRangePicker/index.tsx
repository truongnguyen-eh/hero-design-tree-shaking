...
const RemoveBtnIcon = ({
  ...
  onChange?: MonthRangePickerProps['onChange'];
}) => (
  <Button.Icon
...
const DateRangePicker = ({
  ...
  const handleSelectStartDate = useCallback(
    (date: Date) => {
      ...
      setDateClickCount((prevDateClickCount) => {
  ...
  const handleSelectEndDate = useCallback(
    ...
    [format, onChange, value?.startDate]
  );
