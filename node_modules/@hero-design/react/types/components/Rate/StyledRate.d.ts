...
export declare const StyledRateIconLabel: import("styled-components").StyledComponent<"label", import("styled-components").DefaultTheme, {}, never>;
export declare const StyledRateIconInput: import("styled-components").StyledComponent<"input", import("styled-components").DefaultTheme, {}, never>;
export declare const StyledRateIcon: import("styled-components").StyledComponent<{
    ({ icon, size, intent, spin, id, className, style, sx, "data-test-id": dataTestId, }: import("../Icon").IconProps): import("react").ReactElement<any, string | import("react").JSXElementConstructor<any>>;
...
declare type ThemeStatus = 'disabled' | 'readonly' | 'normal';
export declare const RateWrapper: import("styled-components").StyledComponent<"div", import("styled-components").DefaultTheme, {
    themeLayout: 'medium' | 'large';
    themeStatus?: ThemeStatus | undefined;
}, never>;
export {};
