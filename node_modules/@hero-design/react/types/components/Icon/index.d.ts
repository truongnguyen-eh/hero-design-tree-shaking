...
declare type IconIntent = 'inherit' | 'text' | 'subdued-text' | 'disabled-text' | 'primary' | 'info' | 'danger' | 'warning' | 'success' | 'error';
interface IconProps extends CommonProps {
     ...
     */
    intent?: 'inherit' | 'text' | 'subdued-text' | 'disabled-text' | 'info' | 'primary' | 'danger' | 'warning' | 'success' | 'error';
    /**
...
declare const Icon: {
    ({ icon, size, intent, spin, id, className, style, sx, "data-test-id": dataTestId, }: IconProps): ReactElement;
