...
declare const DatePicker: ({ autoComplete, value, onChange, onBlur, minDate, maxDate, size, invalid, placeholder, prefix, disabled, format, readonly, name, id, className, style, sx, "data-test-id": dataTestId, }: DatePickerProps) => ReactElement;
