...
declare const renderWithTheme: (ui: ReactElement, options?: RenderOptions) => {
    getAllByText: (id: import("@testing-library/react").Matcher, options?: import("@testing-library/react").SelectorMatcherOptions | undefined) => import("./UnsafeArray").UnsafeArray<HTMLElement>;
    getAllByDisplayValue: (id: import("@testing-library/react").Matcher, options?: import("@testing-library/react").MatcherOptions | undefined) => import("./UnsafeArray").UnsafeArray<HTMLElement>;
    findAllByText: (id: import("@testing-library/react").Matcher, options?: import("@testing-library/react").SelectorMatcherOptions | undefined, waitForElementOptions?: import("@testing-library/react").waitForOptions | undefined) => Promise<import("./UnsafeArray").UnsafeArray<HTMLElement>>;
    rerender: (_ui: React.ReactElement<any, string | React.JSXElementConstructor<any>>) => void;
